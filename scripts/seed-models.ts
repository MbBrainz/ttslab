...
const modelData: NewModel[] = [
	...
	},
	{
		...
		architecture: "Moonshine",
		languages: ["ar"],
		hfModelId: "onnx-community/moonshine-tiny-ar-ONNX",
		loaderConfig: {
			framework: "transformers-js",
			pipeline: "automatic-speech-recognition",
		},
		...
		supportsWasm: true,
		description:
			"Moonshine Tiny fine-tuned for Arabic. Massively outperforms Whisper Tiny on Arabic (20.76 vs 66.01 WER on Fleurs).",
		websiteUrl: "https://github.com/usefulsensors/moonshine",
		license: "MIT",
	},
	{
		slug: "lite-whisper-large-v3-turbo",
		name: "LiteWhisper Large v3 Turbo",
		type: "stt",
		status: "supported",
		sizeMb: 400,
		paramsMillions: 600,
		architecture: "Whisper (LiteASR low-rank)",
		languages: ["en", "fr", "de", "es", "it", "ja", "ko", "zh", "pt", "ru"],
		hfModelId: "onnx-community/lite-whisper-large-v3-turbo-ONNX",
		loaderConfig: {
			framework: "transformers-js",
			pipeline: "automatic-speech-recognition",
			dtype: { encoder_model: "fp32", decoder_model_merged: "q4" },
		...
		supportsWasm: true,
		description:
			"41% smaller encoder than Whisper Large v3 Turbo via LiteASR low-rank approximation. 99 languages. Fills the gap between Whisper Small and Large v3 Turbo.",
		websiteUrl: "https://huggingface.co/onnx-community/lite-whisper-large-v3-turbo-ONNX",
		paperUrl: "https://arxiv.org/abs/2502.20583",
		license: "Apache-2.0",
	},
	{
		slug: "moonshine-base-ja",
		...
		architecture: "Moonshine",
		languages: ["ja"],
		hfModelId: "onnx-community/moonshine-base-ja-ONNX",
		loaderConfig: {
			framework: "transformers-js",
			pipeline: "automatic-speech-recognition",
		},
		...
		supportsWasm: true,
		description:
			"Moonshine Base fine-tuned for Japanese. Higher accuracy than Moonshine Tiny Japanese with 61M parameters.",
		websiteUrl: "https://github.com/usefulsensors/moonshine",
		license: "MIT",
	},
	{
		slug: "moonshine-base-ko",
		...
		supportsWasm: true,
		description:
			"Moonshine Base fine-tuned for Korean. Higher accuracy than Moonshine Tiny Korean with 61M parameters.",
		websiteUrl: "https://github.com/usefulsensors/moonshine",
		license: "MIT",
	},
	{
		slug: "moonshine-base-zh",
		...
		architecture: "Moonshine",
		languages: ["zh"],
		hfModelId: "onnx-community/moonshine-base-zh-ONNX",
		loaderConfig: {
			framework: "transformers-js",
			pipeline: "automatic-speech-recognition",
		},
		...
		supportsWasm: true,
		description:
			"Moonshine Base fine-tuned for Chinese (Mandarin). Higher accuracy than Moonshine Tiny Chinese with 61M parameters.",
		websiteUrl: "https://github.com/usefulsensors/moonshine",
		license: "MIT",
	},
	{
		...
		supportsWasm: true,
		description:
			"Cohere's SOTA ASR model — #1 on Open ASR Leaderboard (5.42% WER). 2B params, 14 languages. WebGPU-accelerated. Apache 2.0.",
		websiteUrl: "https://huggingface.co/CohereLabs/cohere-transcribe-03-2026",
		license: "Apache-2.0",
	},
	{
		...
		voices: 1,
		hfModelId: "onnx-community/chatterbox-multilingual-ONNX",
		loaderConfig: {
			framework: "transformers-js",
			dtype: {
				embed_tokens: "fp32",
	...
	},
	{
		...
		sizeMb: 1840,
		paramsMillions: 1000,
		architecture: "Granite Speech (encoder-decoder)",
		...
		supportsWasm: true,
		description:
			"IBM's Granite 4.0 1B Speech — ASR + speech translation in one model. 1B params, WebGPU-accelerated. Supports 6 languages for transcription and cross-language translation. Apache 2.0.",
		websiteUrl: "https://huggingface.co/ibm-granite/granite-4.0-1b-speech",
		license: "Apache-2.0",
	},
	...
	},
	{
		...
		languages: ["en"],
		voices: 1,
		hfModelId: "onnx-community/chatterbox-ONNX",
		loaderConfig: {
			framework: "transformers-js",
			dtype: {
				embed_tokens: "fp32",
	...
	},
	{
		...
		sizeMb: 720,
		paramsMillions: 350,
		architecture: "Chatterbox Turbo (GPT-2 backbone)",
		languages: ["en"],
		voices: 1,
